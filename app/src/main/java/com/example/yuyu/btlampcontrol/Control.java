package com.example.yuyu.btlampcontrol;
...
public class Control extends AppCompatActivity {
    ...
    Button btnOn, btnOff,btnOn2, btnOff2,btnOn3, btnOff3, btnDis;
